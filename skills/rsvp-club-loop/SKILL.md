---
name: RSVP club loop
description: Use for full college club event ops — plan + invite draft, lock gate, Amazon supplies with quality filters, and a separate food order plan — dry-run safe until the user approves publish or payment.
---
