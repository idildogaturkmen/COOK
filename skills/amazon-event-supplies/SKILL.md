...
2. **Rating (tiered):** apply in order — prefer **≥ 4.6**; if none pass, allow **≥ 4.5**; if still none, allow **≥ 4.4**; **below 4.4 = reject**. Always note which tier was used for each item in the report.
...
## Report format
- Passing items table (include rating tier: 4.6 / 4.5 / 4.4)
